 ...
 */
public class RecruitApprovalDto {
    private String bxw_approval_status;
    ...
    private String result;//判断通过还是拒绝
    private int salary_treatment;
    private  String post_name;
    private int post_classification;
    private String details_page_category;
    ...
    public void setBxw_approval_status(String bxw_approval_status) {
        this.bxw_approval_status = bxw_approval_status;
    }
    ...
    public String getDetails_page_category() {
        return details_page_category;
    }

    public void setDetails_page_category(String details_page_category) {
        this.details_page_category = details_page_category;
    }
