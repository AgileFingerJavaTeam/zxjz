 ...
 */
public enum HomepageRecommendEnum {
    ...
    HomepageRecommendEnum(int code, String codeInfo) {
        this.code = code;
    ...
    public String toString() {
        return "HomepageRecommendEnum{" +
                "code=" + code +
                ", codeInfo='" + codeInfo + '\'' +
                '}';
    }

    public static HomepageRecommendEnum stateof(int index) {
        for (HomepageRecommendEnum state : values())
        {
