...
*/
    public  int addPsostJob(@Param("user_id") int user_id, @Param("post_name") String post_name, @Param("settlement_method") String settlement_method, @Param("salary_treatment") String salary_treatment, @Param("commission") String commission, @Param("benefits") String benefits, @Param("position_longitude") String position_longitude, @Param("position_latitude") String position_latitude, @Param("work_location") String work_location, @Param("work_date") String work_date, @Param("work_time") String work_time, @Param("recruitment") int recruitment, @Param("gender_requirements") String gender_requirements, @Param("work_content") String work_content, @Param("hiring_expiration_date") String hiring_expiration_date, @Param("leader") String leader, @Param("leader_phone") String leader_phone, @Param("post_classification") int post_classification, @Param("city") int city);
    ...
    public  int updateStatus(String status_time, @Param("user_id") int user_id, @Param("post_name") String post_name, @Param("settlement_method") String settlement_method, @Param("salary_treatment") String salary_treatment, @Param("commission") String commission, @Param("benefits") String benefits, @Param("position_longitude") String position_longitude, @Param("position_latitude") String position_latitude, @Param("work_location") String work_location, @Param("work_date") String work_date, @Param("work_time") String work_time, @Param("recruitment") int recruitment, @Param("gender_requirements") String gender_requirements, @Param("work_content") String work_content, @Param("hiring_expiration_date") String hiring_expiration_date, @Param("leader") String leader, @Param("leader_phone") String leader_phone, @Param("post_classification") int post_classification, @Param("city") int city);
    public  int updateStatusC(@Param("user_id") int user_id, @Param("post_name") String post_name, @Param("settlement_method") String settlement_method, @Param("salary_treatment") String salary_treatment, @Param("commission") String commission, @Param("benefits") String benefits, @Param("position_longitude") String position_longitude, @Param("position_latitude") String position_latitude, @Param("work_location") String work_location, @Param("work_date") String work_date, @Param("work_time") String work_time, @Param("recruitment") int recruitment, @Param("gender_requirements") String gender_requirements, @Param("work_content") String work_content, @Param("hiring_expiration_date") String hiring_expiration_date, @Param("leader") String leader, @Param("leader_phone") String leader_phone, @Param("post_classification") int post_classification, @Param("city") int city);
    ...
    public Recruitment status(int recruiting_id);
