...
public class AtCollection {
    ...
    private int pPostClassification;
    private String detailsPageCategory;
    private String whetherOnHomepageGuarantee;
    private String goodBeginTime;
    private String goodEndTime;
    private String whetherOnHomepageRecommend;
    ...
    private String firstPageCarouselUrl;
    private String mainPageUrl;
    private String detailsPageIntroduction;
    ...
    public int getpPostClassification() {
        return pPostClassification;
    }

    public void setpPostClassification(int pPostClassification) {
        this.pPostClassification = pPostClassification;
    }
    ...
    public String toString() {
        return "Collection{" +
                ...
                ", pPostClassification=" + pPostClassification +
